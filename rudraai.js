...
const details = fs.readFileSync("details.txt", "utf-8");
const hsdtls = fs.readFileSync("sdtls.txt", "utf-8");
...
module.exports = sansekai = async (client, m, chatUpdate, store) => {
  try {
    ...
    // If the message is not a command, use OpenAI to generate a response
      ...
      const messages = [
        { role: "system", content: details + hsdtls},
    ...
    m.reply("Hold on, You Are Using Me Too Fast!!!😔"),
